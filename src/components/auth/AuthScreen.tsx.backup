      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 lg:px-16">
        <div className="w-full max-w-md">
          ...
          <div className="mb-10 text-center">
            ...
            {/* Fallback logo */}
            <div
              className="w-14 h-14 rounded-2xl mx-auto items-center justify-center hidden"
              style={{ background: gradients.primaryButton, boxShadow: '0 4px 12px rgba(1,63,71,0.25)' }}
            >
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
                <path d="M12 2L2 7l10 5 10-5-10-5z" fill="rgba(255,255,255,0.95)" />
                <path d="M2 17l10 5 10-5" stroke="rgba(255,255,255,0.7)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M2 12l10 5 10-5" stroke="rgba(255,255,255,0.85)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
            {/* Brand name */}
            <h2
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                {view !== 'reset-password' && view !== 'guest-conversion' && (
                  <InputField
                    ...
                    disabled={view === 'guest-conversion'}
                  />
                )}
