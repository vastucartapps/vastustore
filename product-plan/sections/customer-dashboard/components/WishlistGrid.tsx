        ...
        {items.map((item) => (
          ...
          >
            ...
            <div
              ...
              onClick={() => onViewProduct?.(item.product.slug)}
            >
              <img
            ...
            <div style={{ padding: '1rem' }}>
              ...
              <div style={{ marginBottom: '0.75rem' }}>
                ...
                {item.product.mrp > item.product.price && (
                  <div style={{
                    ...
                    MRP ₹{item.product.mrp.toLocaleString('en-IN')}
                  </div>
                )}
              </div>
              ...
              <button
                ...
                style={{
                  width: '100%',
                  backgroundColor: item.product.inStock ? c.primary500 : c.earth300,
                  color: 'white',
                  border: 'none',
                  borderRadius: '0.75rem',
                  padding: '0.75rem',
                  ...
                  transition: 'all 0.2s',
                  opacity: item.product.inStock ? 1 : 0.6,
                }}
                onMouseEnter={(e) => {
                  if (item.product.inStock) {
                    e.currentTarget.style.backgroundColor = c.primary400
