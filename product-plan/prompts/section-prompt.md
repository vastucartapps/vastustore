...
- **SECTION_NAME** = [Human-readable name, e.g., "Cart & Checkout"]
- **SECTION_ID** = [Folder name, e.g., "cart-and-checkout"]
- **NN** = [Milestone number, e.g., "05" — sections start at 02 since 01 is Shell]
